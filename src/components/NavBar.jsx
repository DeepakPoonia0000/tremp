  ...
  return (
    <div>
      ...
      <div className={`navbar ${isOpen ? 'open' : ''}`} style={{ marginTop: "-20px" }}>
        ...
        <div className="links" style={{ background: "rgba(0, 0, 0, 0.04)", padding: "20px" }}>
...
const AccountIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" className="icon icon-account" fill="none" viewBox="0 0 18 19" style={{ width: "2rem" }}>
...
const TwitterIcon = () => (
  <svg aria-hidden="true" focusable="false" className="icon icon-twitter" viewBox="0 0 20 20" style={{ width: "2.2rem" }}>
...
const FacebookIcon = () => (
  <svg aria-hidden="true" focusable="false" className="icon icon-facebook" viewBox="0 0 20 20" style={{ width: "2.2rem" }}>
    <path fill="currentColor" d="M18 10.049C18 5.603 14.419 2 10 2c-4.419 0-8 3.603-8 8.049C2 14.067 4.925 17.396 8.75 18v-5.624H6.719v-2.328h2.03V8.275c0-2.017 1.195-3.132 3.023-3.132.874 0 1.79.158 1.79.158v1.98h-1.009c-.994 0-1.303.621-1.303 1.258v1.51h2.219l-.355 2.326H11.25V18c3.825-.604 6.75-3.933 6.75-7.951Z"></path>
  </svg>
);

const InstagramIcon = () => (
  <svg aria-hidden="true" focusable="false" className="icon icon-instagram" viewBox="0 0 20 20" style={{ width: "2.2rem" }}>
