        ...
        <div className="terms-container">
            ...
            <div className="terms-content">
                <div className="terms-section">
                    <h2>OVERVIEW</h2>
                    <p>This website is operated by Tremp. Throughout the site, the terms “we”, “us” and “our” refer to Tremp. Tremp offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                ...
                <div className="terms-section">
                    ...
                    <p>You agree to indemnify, defend and hold harmless Tremp and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
                </div>
                <div className="terms-section">
                ...
                <div className="terms-section">
                    ...
                    <p>Questions about the Terms of Service should be sent to us at krenterprisesdelhi2023@gmail.com.</p>
                    <p>Our contact information is posted below:</p>
                    <p>Uttan Nagar - 110059<br />
                        GST NO : 07CEEPS7010C1ZT
                    </p>
                </div>
            </div>
        </div>
